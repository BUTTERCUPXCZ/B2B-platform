      ...
      <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 sm:py-4">
        <div className="flex items-center justify-between gap-3 rounded-full bg-white/95 px-3 py-2 shadow-[0_24px_60px_-30px_rgba(0,0,0,0.5)] backdrop-blur">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="#quote"
              className="hidden items-center gap-2 rounded-full bg-brand-orange px-5 py-2.5 text-xs font-semibold tracking-wide text-brand-ink uppercase transition-colors hover:bg-brand-orange-soft sm:inline-flex"
            >
              Book a Demo
            ...
            <button
              ...
              className="inline-flex size-10 items-center justify-center rounded-full bg-brand-orange text-brand-ink transition-colors hover:bg-brand-orange-soft md:hidden"
            >
      ...
      >
        ...
        <div className="mt-auto space-y-3 pt-8">
          <a
            href="#quote"
            onClick={onClose}
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand-orange px-5 py-3 text-xs font-semibold tracking-[0.18em] text-brand-ink uppercase transition-colors hover:bg-brand-orange-soft"
          >
            Book a Demo
            <HugeiconsIcon icon={ArrowRight01Icon} className="size-3.5" />
          </a>
