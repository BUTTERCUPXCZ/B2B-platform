...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    body: "Schedule deliveries to a home, a yard, or an active jobsite. Track every order in real time. The STRUKTURA driver knows the gate code and where to drop your cement.",
    bullets: [
