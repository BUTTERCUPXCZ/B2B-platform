...
const faqs = [
  ...
  },
  {
    ...
    a: "Open a dispute directly from the order page in your account, or email help@struktura.ph with your order ID. Funds stay in escrow while we investigate. Most disputes resolve within 36 hours.",
  },
  {
    q: "How do I become a seller?",
    a: "Submit the ‘Become a Seller’ form (or email sales@struktura.ph). We verify your business permit and ID, then walk you through listing your first 10 items. Most sellers go live within 5 business days of applying.",
  },
  {
