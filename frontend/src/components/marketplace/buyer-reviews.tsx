...
const reviews: Review[] = [
  {
    quote:
      "I order all my project cement and rebar through STRUKTURA now. Prices beat my old yard, delivery hits the site on the day I scheduled, and the receipts auto-export to QuickBooks. Saved me at least 6 hours a week of running around.",
    name: "Marlon Reyes",
  ...
  {
    quote:
      "The verified-pro badge actually means something. We hired a contractor through STRUKTURA to extend our kitchen and the quality matched the photos in their portfolio. Milestone payments meant we never felt out of control.",
    name: "Daniel Okafor",
